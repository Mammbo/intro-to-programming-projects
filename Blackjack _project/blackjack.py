...
while True:
    ...
    if 21 == sum(Ppoints) and 21 == sum(Dpoints):
        ...
        print(
            f"Tie, No One Wins, Total Amount Betted: {bet}\nTotal Amount You Have: {money} "
        )
        ...
        print(f"Player's Points: {sum(Ppoints)}\nDealer's Points: {sum(Dpoints)}\n")
        print(
            f"Player wins, Total Amount Won: {bet}\nTotal Amount You Now Have: {money} "
        )
    elif 21 == sum(Dpoints):
        ...
        print(f"Player's Points: {sum(Ppoints)}\nDealer's Points: {sum(Dpoints)}\n")
        print(
            f"Dealer wins, Total Amount Lost: {bet}\nTotal Amount You Now Have: {money} "
        )
        ...
        print(f"Player's Points: {sum(Ppoints)}\nDealer's Points: {sum(Dpoints)}\n")
        print(
            f"Both players had more than 21, No One Wins, Total Amount Betted: {bet}\nTotal Amount You Have: {money} "
        )
    ...
    while True:
        ...
        if money <= 0:
            print("NOOO YOU LOST ALL YOUR MONEY :(. ")
            break
        else:
